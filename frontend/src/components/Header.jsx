  ...
  return (
    <>
      ...
      >
        ...
        <div className={`bg-black text-white text-xs py-2 transition-all duration-300 ${
          !showHeader || !isTop ? 'h-0 py-0 overflow-hidden opacity-0' : 'h-auto opacity-100'
        }`}>
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          ...
          <div className={`lg:hidden mt-3 transition-all duration-300 ${
            !showHeader || !isTop ? 'h-0 opacity-0 overflow-hidden' : 'h-auto opacity-100'
          }`}>
      ...
      <button
        ...
        className={`fixed right-6 z-40 bg-black text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:bg-gray-800 ${
          !showHeader && !isTop 
